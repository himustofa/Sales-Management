...
public class Validation {
	...
	/**
	 * @author 
	 *	compares two dates (one is user given another is current Date)
	 */
	...
	/**
	 * @CTS Programmer
	 *	add year with Date and return String
	 */
	...
	/**
	 * @CTS Programmer
	 *	check employee's age according to company policy
	 */
	 ...
	 * ^[a-zA-Z]([\\.]?)[\\sa-zA-Z]*[\\.]?+$"
	 * @CTS Programmer
	 *	ensure String is not allowed to have number and special character
	 */
	...
	/**
	 * @CTS Programmer
	 *	ensure String is allowed to have number and/or character
	 */
	...
	/**
	 * @CTS Programmer
	 *	ensure String is allowed to have only number
	 */
